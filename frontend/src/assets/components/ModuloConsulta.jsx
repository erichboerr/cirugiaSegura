...
const ModuloConsulta = (props) => {
  ...
  return (
    <section className="row shadow-lg p-3 mb-2 bg-body-tertiary rounded consulta">
      ...
      <div className="row justify-content-evenly">
        <div className="card text-center col-md-3">
          <div className="card-body">
            ...
            {errors.PulseraChk && (
              <span className="text-danger">{errors.PulseraChk.message}</span>
            )}
          </div>
        </div>
        <div className="card text-center col-md-3">
          <div className="card-body">
            ...
            <div className="form-check">
              ...
              />
              <label className="form-check-label" htmlFor="ConsentimientoChkNo">
                No
              </label>
            </div>
